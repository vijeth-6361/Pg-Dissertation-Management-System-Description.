...
$stmt = $db->prepare('SELECT * FROM appointment WHERE NOT ((appointment_end <= :start) OR (appointment_start >= :end)) AND faculty_id = :faculty');
$stmt->bindParam(':start', $params->start);
$stmt->bindParam(':end', $params->end);
$stmt->bindParam(':faculty', $params->faculty);
$stmt->execute();
